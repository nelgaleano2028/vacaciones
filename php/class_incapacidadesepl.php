...
class vacaciones{
    ...
    public function aceptar_vacaciones(){
            ...
            $sql="update ausencias_tmp set estado='C', cod_encardo='".$this->encargado."', RESPUESTA_POR = '$respuesta' where cnsctvo='".$this->consecutivo."' and cod_epl ='".$this->cod_epl."'";
    ...
    private function cambia_estado_conf(){
       ...
       public function cambia_estado_cance(){
            ...
            global $conn;
          $respuesta = $_SESSION['nombre'].' '. $_SESSION['ape'];
            $sql="update ausencias_tmp set estado='R', observacion='".$this->observacion."', cod_encardo='".$this->encargado."', RESPUESTA_POR = '$respuesta' where COD_EPL = '".$this->cod_epl."' and cnsctvo='".$this->consecutivo."'";
            $rs=$conn->Execute($sql);
            if($rs){
                $res = true;
            }
...
from empleados_basic e , empleados_gral g,incapacidades_tmp a, cargos c, centrocosto2 c2
where e.cod_epl = g.cod_epl
and (g.cod_jefe ='$codiepl' or e.cod_epl ='$codiepl'
or g.cod_jefe in (select cod_epl from empleados_gral where cod_jefe ='$codiepl') )
...
and a.cod_con=(select descripcion from parametros_nue where nom_var='param_vacas_cod_con')";
 ...
 from empleados_basic e , empleados_gral g, ausencias_tmp a, cargos c, centrocosto2 c2
...
";
 ...
 e.cedula AS CEDULA , e.nom_epl AS NOM_EPL, e.ape_epl AS APE_EPL,c.nom_car AS NOM_CAR, 
 c2.nom_cc2 AS AREA, a.estado AS ESTADO, a.fec_ini AS FEC_INI,  a.fec_fin AS FEC_FIN,a.dias AS DIAS 
 from empleados_basic e , empleados_gral g, ausencias_tmp a, cargos c, centrocosto2 c2, periodos p
 where g.cod_jefe ='$codiepl'  
 and e.cod_epl = g.cod_epl
 and e.cod_epl = a.cod_epl
 and e.cod_car = c.cod_car
 ...
 order by a.fec_ini desc";
     ...
     public function solicitud_pendientes_epl_gral(){
         ...
         $codiepl = $_SESSION['cod'];
            ...
            from empleados_basic emp, cargos car, centrocosto2 cen ,ausencias_tmp au, EMPLEADOS_GRAL b
