...
$sql = "INSERT INTO CLICKS (TABLA, CLICK, FECHA) VALUES ('CERTIFICADO LABORAL','1',SYSDATE)";
$conn->Execute($sql);
...
?>
 <script language='javascript'>
      alert("Ingrese a quien va dirigido");
      window.location="configcertificado.php";
    </script>
<?php
}
...
if(@$_POST["certificado"]=="opcion2" or @$value=="opcion2"){
...
else  if(@$_POST["certificado"]=="opcion3" or @$value=="opcion3"){
		$content = '<page  backleft="12mm" backright="12mm">
<STYLE type="text/css">
