...
?> 
	<script> 
		alert("Ingresa a quien va dirigido");
		close();
	</script> 
<?php 
}
...
if($_POST["cedula"]){
	...
	$sql="select COD_EPL from empleados_basic where cedula='".$_POST["cedula"]."' and estado='A'";
...
//var_dump($empresa_real);die("");
//var_dump($nit_real);die("");
...
$sql =  "select fec_ant_emp_gru as VALOR from empleados_gral WHERE COD_EPL = '$codigo'";
$rs = $conn->Execute($sql);
$rowsqqwe = $rs->fetchrow();
if(isset($rowsqqwe['VALOR'])){
...
WHERE emp.cod_ciu=ciu.cod_ciu AND ciu.cod_dpt=depa.cod_dpt AND emp.cod_emp in(select cod_emp from empleados_basic where cod_epl='".$codigo."')";
...
$qry2="select c.SEXO, a.COD_CTG, NOM_EPL,APE_EPL,CEDULA,SAL_BAS,NOM_CAR,TO_CHAR(INI_CTO,'DD-MM-YYYY')as INI_CTO, TO_CHAR(FEC_RET,'DD-MM-YYYY')as FEC_RET, a.TIPO_DOC from empleados_basic a, cargos b, empleados_gral c where a.cod_car=b.cod_car and a.cod_epl=c.cod_epl and a.cod_epl='".$codigo."'";
...
WHERE E.COD_EPL ='".$codigo."'
AND E.TIP_PAGO =P.TIP_PER
AND E.COD_EMP =P.COD_EMP
AND P.FEC_INI <=E.FEC_ULT_NOM
AND DIF_FECHAS(P.FEC_INI,E.FEC_ULT_NOM,'".$codigo."' ,0, P.FEC_INI )/30 BETWEEN 0 AND 6
...
//Integral  
$qry30="select * from epl_grupos where cod_gru='2' and cod_epl='".$codigo."'";
...
//Aprendices
$qry31="select * from epl_grupos where cod_epl='".$codigo."' and  (cod_gru='3' or cod_gru='5')";
...
$qry32="select TO_CHAR(FEC_ANT_EMP_GRU,'DD-MM-YYYY') as VTO_CTO from empleados_gral where  cod_epl='".$codigo."'";
...
if($fecha_venc){
	...
	$cadena9='hasta el '.$fecha_venc.' fecha en la cual cedi&oacute; contrato de trabajo del colaborador a la empresa TELEFONICA GLOBAL TECHNOLOGY SUCURSAL COLOMBIA. NIT 900773345-7';
...
$qry33="select VALOR from epl_con_fijos where cod_epl='".$codigo."' and cod_con='1004'";
...
$cadena11='Adicionalmente recibe cheques de BIG PASS por valor de '.$letrasnum20.' ($'.number_format($valor_big, 0, ",", ".").'). Este concepto no constituye salario en los t&eacute;rminos del art&iacute;culo 15 de la ley 50 de 1990.';
}
                ...
                <table border="0" style="font-family:helvetica;">
					...
					<tr>
                        <td colspan="2"><br></td>
							...
							<tr>
								<td colspan="2" align="right" style="font-size :7px;">www.telefonica.com.co</td>
							</tr>
							<tr>
					...
					<tr>
                     ...
                     if($codigo=='11300818' or $codigo=='1049618738'){
					
                   $content .= '<tr>
                      <td  colspan="2" ><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.@$cadena10.' No '.$cedula.',  suscribi&oacute; contrato de '.$cadena8.' con la empresa <span style="">COLOMBIA TELECOMUNICACIONES S.A. E.S.P NIT. 830.122.566-1</span> a partir de '.$fecha.' '.@$cadena9.', desempe&ntilde;ando a la fecha el cargo de '.$cargo.',  con '.$cadena7.' de '.$letrasnum.' ($<span style="">'.number_format($sueldo,0,",",".").'</span>). '.$cadena6.'</p></td>
                    </tr>';
					}else{
					
					$content .= '<tr>
                      <td  colspan="2" ><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.@$cadena10.' No '.$cedula.',  suscribi&oacute; contrato de '.$cadena8.' con la empresa COLOMBIA TELECOMUNICACIONES S.A. E.S.P NIT. 830.122.566-1 a partir de '.$fecha.' '.@$cadena9.', desempe&ntilde;ando a la fecha el cargo de '.$cargo.',  con '.$cadena7.' de '.$letrasnum.' ($<span style="">'.number_format($sueldo,0,",",".").'</span>). '.$cadena6.'</p></td>
                    </tr>';
					}
					...
					$content .= '<tr>
					 		...
					 		<tr>
                        		<td  colspan="2" CLASS="justifyText">'.@$cadena4.'</td>
                    		</tr>';
					...
					<tr>
                        <td  colspan="2"><p CLASS="justifyText">Se aclara que la fecha de inicio del contrato de trabajo cedido de '.$cadena.', no tiene cambio o modificaci&oacute;n, por lo cual esta cesi&oacute;n de contrato mantiene la fecha de antig&uuml;edad o fecha de inicio del contrato de trabajo cedido.</p></td>
                    </tr>
					<tr>
                        <td  colspan="2"><br></td>
                    </tr>
...
$sql15="insert into log_certificados (CNSCTIVO, NOM_EPL, APL_EPL, COD_EPL, FECHA, VALUE, NOM_CERTIFICADO, DESTINO, CADENA, CEDULA, FECHA_LAB, CADENA9, CADENA8, CARGO, DIAACTUAL, NOMBRE_MES, ANOACTUAL, CADENA7, LETRASNUM, SUELDO, CADENA6, CADENA4, CADENA11, CADENA10, ESTADO, EMPRESA, NIT) values('".$cantidad2."','".$nombre."','".$apellido."','".$codigo."',SYSDATE, '".$opcion."', '".$nom_certificado."','".$destino."','".$cadena."','".$cedula."','".$fecha."','".$cadena9."','".$cadena8."','".$cargo."','".$diaactual."','".$nombre_mes."','".$anoactual."','".strip_tags($cadena7)."','".$letrasnum."','".$sueldo."','".strip_tags($cadena6)."','".strip_tags($cadena4)."','".strip_tags($cadena11)."','".$cadena10."','".$estado."', '".$empresa_real."', '".$nit_real."')";
...
.justifyText{text-align:justify; font-size:12px; line-height: 20px;}
                ...
                <table border="0" style="font-family:helvetica;">
                   ...
                   <tr>
                         <td colspan="2"><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.@$cadena10.' No '.$cedula.',  suscribi&oacute; contrato de '.$cadena8.' con la empresa COLOMBIA TELECOMUNICACIONES S.A. E.S.P NIT. 830.122.566-1 a partir de '.$fecha.' '.@$cadena9.', desempe&ntilde;ando a la fecha el cargo de '.$cargo.'.</p></td> </tr>	'; 
...
$sql15="insert into log_certificados (CNSCTIVO, NOM_EPL, APL_EPL, COD_EPL, FECHA, VALUE, NOM_CERTIFICADO, DESTINO, CADENA, CEDULA, FECHA_LAB, CADENA9, CADENA8, CARGO, DIAACTUAL, NOMBRE_MES, ANOACTUAL, CADENA10, ESTADO, EMPRESA, NIT) values('".$cantidad2."','".$nombre."','".$apellido."','".$codigo."',SYSDATE, '".$opcion."', '".$nom_certificado."','".$destino."','".$cadena."','".$cedula."','".$fecha."','".$cadena9."','".$cadena8."','".$cargo."','".$diaactual."','".$nombre_mes."','".$anoactual."','".$cadena10."','".$estado."', '".$empresa_real."', '".$nit_real."')";
...
/*
    $sql_insert="insert into log_certificados values('$cantidad2','$nombre','$apellido','$codigo', SYSDATE, '$opcion', '$nom_certificado', '$destino')";
...
$qry32="select TO_CHAR(VTO_CTO,'DD-MM-YYYY')as VTO_CTO from empleados_basic where estado='A' and cod_epl='".$codigo."'";
...
.justifyText{text-align:justify; font-size:12px; line-height: 20px;}
                ...
                <table border="0" style="font-family:helvetica;">
                   ...
                   $content .= '<tr>
                         <td colspan="2"><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.$cadena10.' No '.$cedula.', se encuentra vinculado(a) para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.' con '.$cadena7.' de '.$letrasnum.' ($<span>'.number_format($sueldo, 0, ",", ".").'</span>). '.$cadena6.' </p></td>
                    </tr>';
					}else{
					
					$content .= '<tr>
                         <td colspan="2"><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con c&eacute;dula de ciudadania No '.$cedula.', se encuentra vinculado(a) para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.' con '.$cadena7.' de '.$letrasnum.' ($<span>'.number_format($sueldo, 0, ",", ".").'</span>). '.$cadena6.' </p></td>
                    </tr>';
					}
...
.justifyText{text-align:justify; font-size:12px; line-height: 20px;}
                ...
                <table border="0" style="font-family:helvetica;">
                    ...
                    <tr>
                         <td colspan="2"><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.$cadena10.' No '.$cedula.', labora para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.'.</p></td></tr>'; 
...
.justifyText{text-align:justify; font-size:12px; line-height: 20px;}
                ...
                <table border="0" style="font-family:helvetica;">
                   ...
                   $content .= '<tr>
                         <td colspan="2"><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con c&eacute;dula de ciudadania No '.$cedula.', se encuentra vinculado(a) para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.' con '.$cadena7.' de '.$letrasnum.' ($<span style="">'.number_format($sueldo, 0, ",", ".").'</span>). '.$cadena6.'</p></td>
                    </tr>';
					}else{
					
					$content .= ' <tr>
                         <td  colspan="2" ><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.@$cadena10.' No '.$cedula.',  se encuentra vinculado(a) para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.' con '.$cadena7.' de '.$letrasnum.' ($<span style="">'.number_format($sueldo,0,",",".").'</span>). <span>'.$cadena6.'</span></p></td>
                    </tr>';
					}
