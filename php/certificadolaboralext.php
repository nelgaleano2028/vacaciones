...
.justifyText{text-align:justify; font-size:12px; line-height: 20px;}
                ...
                <table border="0" style="font-family:helvetica;">
                  ...
                  $content.= ' <tr>
                         <td colspan="2"><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.$cadena10.' No '.$cedula.', se encuentra vinculado(a) para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.'.</p></td> </tr>				
...
.justifyText{text-align:justify; font-size:12px; line-height: 20px;}
                ...
                <table border="0" style="font-family:helvetica;">
                   ...
                   $content .= ' <tr>
                         <td  colspan="2" ><p CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.@$cadena10.' No '.$cedula.', se encuentra vinculado(a) para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.' con '.$cadena7.' de '.$letrasnum.' ($<span style="">'.number_format($sueldo,0,",", ".").'</span>). '.$cadena6.'</p></td>
                    </tr>';
					}else{
						$content .= ' <tr>
                         <td  colspan="2" CLASS="justifyText">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.@$cadena10.' No '.$cedula.',  se encuentra vinculado(a) para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.' con '.$cadena7.' de '.$letrasnum.' ($<span style="">'.number_format($sueldo,0,",",".").'</span>). '.$cadena6.'</td>
                    </tr>';
