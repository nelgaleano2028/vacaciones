...
$data=$administrador->cronograma_nomina();
...
<script type="text/javascript" charset="utf-8" src="../extras/TableTools/media/js/TableTools.min.js"></script>
 ...
 <center>
			<h2>Cronograma de N&oacute;mina</h2>   
<div style="width:80%">
                ...
                <th  scope="col" >Pago</th>	
			      ...
			      ?>
                  <td><?php echo $data[$i]['mes']; ?></td>
			      <td><?php echo $data[$i]['dia_cierre']; ?></td>
                  <td><?php echo $data[$i]['cierre']; ?></td>
			      <td><?php echo $data[$i]['dia']; ?></td>
                  <td><?php echo $data[$i]['pago']; ?></td>
