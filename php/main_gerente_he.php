  ...
  <table width="100%" border="0" height="auto">
    <tr>
      <td height="auto" valign="top"><table width="100%" border="0" height="auto">
        ...
        <tr>
          <td width="25%" height="48" class="hv"><a href="he_solicitudes_epl_gere.php" target="mainFrame">Historial Solicitudes por Empleado</a></td>

          <td width="25%" height="48" class="comprobantes"><a href="he_epl_gere_rechazados.php" target="mainFrame">Historial Solicitudes Rechazadas</a></td>


	  <td width="25%" height="48" class="vacaciones"><a href="horasextras_gral_gere.php" target="mainFrame">Solicitudes Pendientes por Aprobar o Rechazar</a></td>
 </tr>
        <tr>
          <td id='content' height="550" colspan="4">
        <div class="overview"> <iframe src="horasextras_gral_gere.php"  name="mainFrame" width="100%" height="620px"  scrolling="auto" frameborder="0" id="mainFrame"></iframe></td>
        </tr>
