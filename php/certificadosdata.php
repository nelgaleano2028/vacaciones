...
<thead>
	 ...
	 <?php
	     for($i=0; $i<count($lista6); $i++){
	 ?>
	 <tr class="gradeX">
     	<td><?php echo number_format($lista6[$i]['valor'], 2, ",", ".") ?></td>
		<td><?php echo number_format($lista6[$i]['meses'], 0, ",", ".") ?></td>
		<td><?php echo number_format($lista6[$i]['valor_men'], 2, ",", ".") ?></td>
		<td><?php echo $lista6[$i]['fecha'] ?></td>
