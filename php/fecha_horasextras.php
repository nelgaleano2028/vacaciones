...
if($_POST["fecha_ini"]=='14-10-2015 and $_POST["dias"]=='15'){
echo '04-11-2015';

}else if($_POST["fecha_ini"]=='24-10-2015' and $_POST["dias"]=='7'){
echo '04-11-2015';

}else if($_POST["fecha_ini"]=='31-10-2015' and $_POST["dias"]=='2'){
echo '04-11-2015';
...
$qry19="SELECT COD_CON AS COD FROM horasextras_tmp
WHERE
...
$qry18="select fec_ini AS FECHAINI from horasextras_tmp where fec_ini = to_date('".$fecha_a_evaluarini."','DD-MM-YY') and estado in ('P','C') and cod_epl='".$codigo."'";
...
$qry13="select * from horasextras_tmp where cod_con='".$cod_con."' and cod_aus='".$cod_aus."' and estado = 'P' and cod_epl='".$codigo."'";
...
//echo $dias;die("");
		...
		$qry1="SELECT COD_CON AS COD FROM horasextras_tmp
WHERE
cod_con='".$cod_con."' and cod_aus='".$cod_aus."' and estado in ('P','C') and cod_epl='".$codigo."'
and (to_date('$fecha_a_evaluarini','DD-MM-YY') between fec_ini and fec_fin or
