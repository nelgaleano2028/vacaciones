...
class vacaciones{
    ...
    public function aceptar_vacaciones(){
            ...
            if($odbc == "oci8"){
            $sql="update horasextras_tmp set estado='C', cod_encardo='".$this->encargado."', RESPUESTA_POR = '$respuesta' where cnsctvo='".$this->consecutivo."' and cod_epl ='".$this->cod_epl."'";
    ...
    private function cambia_estado_conf(){
            ...
            $sql="update horasextras_tmp set estado='C', cod_encardo='".$this->encargado."', RESPUESTA_POR = 'Administrador' where cod_epl='".$this->cod_epl."' and cnsctvo='".$this->consecutivo."'";
            $rs=$conn->Execute($sql);
            if($rs){
                $res = true;
            }
       ...
       public function cambia_estado_cance(){
            ...
            $sql="update horasextras_tmp set estado='R', observacion='".$this->observacion."', RESPUESTA_POR = 'Administrador' where cnsctvo='".$this->consecutivo."' and cod_epl='".$this->cod_epl."'";
            $rs=$conn->Execute($sql);
            if($rs){
                $res = true;
            }
...
au.FEC_SOLICITUD as FECHASOL,
au.CNSCTVO as CONSECUTIVO,
au.RESPUESTA_POR as RESPUESTA,
au.OBSERVACION as RAZON,
            emp.cedula as CEDULA,emp.nom_epl as NOM_EPL,
            emp.ape_epl as APE_EPL,car.nom_car as NOM_CAR,
...
from horasextras_tmp a, empleados_basic e, cargos c, periodos p, centrocosto2 cc
...
";
     ...
     /*
         ...
         *
        */
        public function mensaje_solicitud($contenido,$portal,$youtube,$facebook,$twitter,$titulo,$imagen='http://i60.tinypic.com/f1wewi.png'){
