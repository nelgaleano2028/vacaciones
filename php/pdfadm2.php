...
$qry0="select g.cod_jefe as COD_JEFE, b.cedula as CEDULA, b.nom_epl as NOM_EPL, b.ape_epl as APE_EPL, g.email as EMAIL from empleados_gral g, empleados_basic b where g.cod_epl=b.cod_epl and b.cod_epl='".$cedulas[$i]."' and b.estado='A'";
...
$email=$row["EMAIL"];
$cod_jefe=$row["COD_JEFE"];
$nombre=$row["NOM_EPL"];
$apellido=$row["APE_EPL"];
$cedula_epl=$row["CEDULA"];
...
$email='marisol.ducuara@telefonica.com';
...
if (!function_exists('cortar_caracter')) { 
...
/*
$qry0="select b.cedula as CEDULA,b.cod_epl AS COD_EPL,g.email AS EMAIL from empleados_gral g, empleados_basic b where g.cod_epl=b.cod_epl and b.cod_epl='".$cedulas[$i]."'";
...
*/
    ...
    */
       ...
       $mail->Subject = "Certificado de Ingresos y Retenciones"; // Este es el titulo del email.
       
       $body = "Se le hace entrega de su Certificado de Ingresos y Retenciones.<br><br><br>";
	   ...
	   // if($exito){
          ...
          // }else{
            // echo '<script>alert("Hubo un inconveniente. revisa los correos de los empleados en la base de datos."); window.close();</script>';
          // }
	   
	   ///SE INSERTA EL CONTROL DE ENVIO DE CORREOS
	   $sqlmail = "INSERT INTO t_admail (CEDULA, NOMBRES, APELLIDOS, FECHA_REG, NOVEDAD, COMENTARIO, EMPRESA) VALUES ('".$cedula_epl."','".$nombre."','".$apellido."',SYSDATE,'Certificado de Ingresos y Retencion','".$email."','".$empresamail."')";
...
echo '<script>alert("Se hizo el envio satisfactoriamente."); window.close();</script>';
