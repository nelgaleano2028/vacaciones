...
$qry1="select fec_ini as FEC_INI,fec_fin as FEC_FIN,dias as DIAS,cnsctvo as CNSCTVO from ausencias_tmp where cod_epl='".$codigo."'";
    ...
    $conteo=0;
     ...
     while($i<count(@$lista1)){
      ...
      ?>
        ...
        <td style="text-align:center"><a href="editar.php?numero=<?php  echo $lista1[$i]["consecutivo"]; ?>">Editar</a></td>
			</tr><?php $i++; }?>
