...
$sqlr =  "select fec_ant_emp_gru AS VALOR from empleados_gral WHERE COD_EPL = '$codigo' and fec_ant_emp_gru =  to_date('01/02/2015','DD-MM-YY')";
$rs = $conn->Execute($sqlr);
$rowsq = $rs->fetchrow();

if(isset($rowsq['VALOR'])){
	?>
<script type="text/javascript">
window.location="admin_generacion2.php";
</script>
<?php	
}
                ...
                <table border="0" style="font-family:helvetica;">
					...
					<tr>
                        <td colspan="2"><br></td>
							...
							<tr>
								<td colspan="2" align="right" style="font-size :7px;">Consecutivo: '.$cantidad2.'</td>
							</tr>
                   ...
                   $content .= '<tr>
                    ...
                    <tr>
                        <td colspan="2"><p CLASS="justifyText">La presente certificaci&oacute;n se expide a solicitud del interesado a los <span ">'.$diaactual.'</span> dias del mes de <span ">'.$nombre_mes.'</span> de <span ">'.$anoactual.'</span> para ser presentado a '.$destino.'</p></td>
                    </tr>
                    	<tr>
                        <td  colspan="2"><br></td>
                    </tr>
...
.justifyText{text-align:justify; font-size:12px; line-height: 20px;}
                ...
                <table border="0" style="font-family:helvetica;">
                   ...
                   $content .= '<tr>
					...
					$content .= '<tr>
                         <td colspan="2" CLASS="justifyText" >El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.$cadena10.' No '.$cedula.', se encuentra vinculado(a) para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.' con '.$cadena7.' de '.$letrasnum.' ($<span ">'.number_format($sueldo, 0, ",", ".").'</span>) '.$cadena6.'</td>
                    </tr>';
					
					/*$content .= '<tr>
                         <td colspan="2" CLASS="" style="text-align:justify;font-size:12px; line-height: 20px;">El suscrito Gerente Centro de Servicios Compartidos certifica que '.$cadena.' con '.$cadena10.' No '.$cedula.', se encuentra vinculado(a) para la compa&ntilde;&iacute;a, desde el '.$fecha.' '.@$cadena9.', con un contrato de '.$cadena8.', en el cargo de '.$cargo.' con '.$cadena7.' de '.$letrasnum.' ($<span ">'.number_format($sueldo, 0, ",", ".").'</span>) '.$cadena6.'</td>
                    </tr>';*/
