...
<table width="100%" border="0" >
  <tr>
    <td><p>Consideraciones a tener en cuenta:</p>
      <p>&nbsp;</p>
      <ul type="disc">
        <li><em>Importante validar las horas extras solicitadas de tus colaboradores</em>.</li>
        <li><strong><em>Verifica la programación de tu equipo de trabajo antes de la aprobación</em></strong>.  </li>
        <li><strong><em>Si consideras que un colaborador debe cambiar las fechas de programación, puedes marcarla como rechazada</em></strong>. </li>
        <li class="a">Importante, Una vez aprobadas las horas extras, la herramienta no permite cambios en la programación.</li>
      </ul>
      <p>&nbsp;</p>
      ...
      <ul type="disc">
        ...
        <span class="contenido" style=" alignment-adjust:central; margin-top:0px;"><a href="prueba.php?he=asdqiisk&us=q1e5d69e&pa=g86r5h5f&flag=<?php echo $flag;?>" target="_blank"><img src="../imagenes/boton_administradorhora.png" width="137" height="37" /></a></span></p>
