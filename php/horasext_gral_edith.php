...
/*paginacion id de la tabla*/
			...
			"sDom": '<"H"TfrlP>t<"F"ip><"clear">',
		        "oTableTools": {
								"sSwfPath": "../extras/TableTools/media/swf/copy_csv_xls_pdf.swf",
				                       		"aButtons": [
								{"sExtends": "xls","sButtonText": "Guardar a Excel","sFileName": "solicitudes_turnosdetrabajo_admin.xls","bFooter": false,"mColumns":[0,1,2,3,4,5,6,7,8]},
								{"sExtends": "pdf","sButtonText": "Guardar a PDF","sTitle": "Solicitudes de turnos de trabajo por empleado","sFileName": "solicitudes_turnosdetrabajo_admin.pdf","sPdfOrientation": "landscape","mColumns":[0,1,2,3,4,5,6,7,8]},
 ...
 <center>
  <form method="post" name="formulario"  id="formulario" action='horas_gral.php'> 
...
<p style="text-align:left">Si tiene problemas para exportar la tabla verifique que tiene instalado el reproductor de adobe flash player, de lo contrario descargue <a href="http://get.adobe.com/es/flashplayer/">aqui</a>, si persiste con el inconveniente por favor abrir la pagina WEB con Google Chrome. </p>
				...
				<th  scope="col">Cargo</th>
			     ...
			     ?>
				  ...
				  <input type="checkbox" name="check_list[]" id=<?php echo $lista3[$i]['consecutivo']; ?> value='<?php echo $lista3[$i]['codigo']; ?>,<?php echo $lista3[$i]['consecutivo']; ?>,<?php echo $lista3[$i]['cod_area']; ?>,<?php echo $lista3[$i]['ausencia']; ?>,<?php echo $lista3[$i]['concepto']; ?>,<?php echo $lista3[$i]['dias']; ?>,<?php echo $inicial; ?>, <?php echo $final; ?>'>
