...
<thead>
	 ...
	 <?php
	     for($i=0; $i<count($lista4); $i++){
	 ?>
	 <tr class="gradeX">
     	<td><?php echo $lista4[$i]['fecha_pro'] ?></td>
		<td><?php echo number_format($lista4[$i]['valor'], 2, ",", ".") ?></td>
		<td><?php echo $lista4[$i]['cantidad'] ?></td>
		<td><?php echo number_format($lista4[$i]['sueldo'] , 2, ",", ".")?></td>
	 </tr>	
	  <?php
	  }
	  ?>
