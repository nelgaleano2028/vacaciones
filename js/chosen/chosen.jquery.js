...
*/
  ...
  AbstractChosen = (function() {
    function AbstractChosen(form_field, options) {
      ...
      this.default_text_default = this.is_multiple ? "Seleccione algunas de las opciones" : "Seleccione una opcion";
      this.setup();
      this.set_up_html();
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      this.choices = 0;
      return this.results_none_found = this.options.no_results_text || "No coinciden con";
    };
