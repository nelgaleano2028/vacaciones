...
$qry0="select * from empleados_gral g, empleados_basic b where g.cod_epl=b.cod_epl and b.cod_epl='".$cedulas[$i]."' and b.estado='A'";
...
<div style="position:absolute; top:103px; font-size:8px">'.$EMPRESA_11.'</div>  
