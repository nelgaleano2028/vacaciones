...
$direccion_envio= $_SESSION['cor']; 	
$direccion_envio2= 'novedades.nominacolombia@telefonica.com'; 
...
$url= 'http://10.80.10.10/vacaciones/contactenos-v4'; 	
...
//var_dump($_FILES['archivo']['name']); 
	...
	do  {
		if(isset($_FILES['archivo']['tmp_name'][$i])) 
			...
			//move_uploaded_file($_FILES['archivo']['tmp_name'][$i],'archivos/'.$_FILES['archivo']['name'][$i]);			
...
$contenido .= '<p>Cedula: <strong>'.$ididen .'</strong></p>';
...
<h3>A  continuación descarga tu formulario único haciendo <a href="../php/download.php?file=../descargables/FormatoUnicoNovedadesdeNomina.xls" style="color: #770003">clic aquí</a>.				
</h3>
...
<form action="<?php echo $PHP_SELF;?>" method="post" enctype="multipart/form-data">
	...
	<input name="nombre" type="text" value="<?php echo @$_SESSION['nombre'];?> <?php echo @$_SESSION['ape'];?>"  size="40" readonly="readonly" <?php if (isset ($flag) && $_POST['nombre']=='') { echo 'class="error"';} else {echo 'class="campo"';} ?> /></p>
	
	<p><strong>Email*</strong><br />
	<input name="email" type="text"  value="<?php echo @$_SESSION['cor'];?>" size="40" readonly="readonly" <?php if (isset ($flag) && $_POST['email']=='') { echo 'class="error"';} else {echo 'class="campo"';} ?> /></p>
